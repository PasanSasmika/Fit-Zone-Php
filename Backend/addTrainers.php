...
if (isset($_POST['add_trainer'])) {
    ...
    $trainer_image = str_replace(' ', '_', $trainer_image); 
    ...
    if ($trainer_image == '') {
        ...
        if (empty($trainer_name) || empty($trainer_expe) || empty($trainer_Cinfo) || empty($description) || empty($trainer_image)) {
            ...
            if ($upload) {
                ...
                $message[] = 'Could not add the trainer';
            }
        }
    }
}
        ...
        <div class="class-form">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="trainer_name" placeholder="Enter trainer's full name">
                </div>

                <div class="form-group">
                    <label for="expertise">Expertise:</label>
                    <input type="text" id="expertise" name="trainer_expe" placeholder="e.g., Yoga, Crossfit, Personal Training">
                </div>

                <div class="form-group">
                    <label for="contact">Contact Info:</label>
                    <input type="text" id="contact" name="trainer_Cinfo" placeholder="Phone/Email">
                </div>

                <div class="form-group">
                    <label for="description">Description:</label>
                    <textarea id="description" name="description" placeholder="About the trainer..."></textarea>
                </div>
                ...
                <div class="form-group">
                    <button type="submit" name="add_trainer"><i class='bx bx-plus'></i> Add Trainer</button>
                </div>
            </form>
        </div>
            ...
            <?php while ($row = mysqli_fetch_assoc($select)) { ?>
                <div class="class-card">
                    <div class="class-card-image">
                        <span class="trainer-expertise"><?php echo $row['trainer_expe']; ?></span>
                    ...
                    <div class="class-card-info">
                        <p><strong>Expertise:</strong> <?php echo $row['trainer_expe']; ?></p>
                        <p><strong>Contact Info:</strong> <?php echo $row['trainer_Cinfo']; ?></p>
                        <p class="class-card-description"><?php echo $row['description']; ?></p>
                    </div>
                    <a href="<?php echo $_SERVER['PHP_SELF']; ?>?delete=<?php echo $row['id']; ?>" class="btn delete_btn" onclick="return confirm('Are you sure you want to delete this trainer?');"><i class='bx bxs-trash'></i> Delete</a>                </div>
            <?php } ?>
        </div>
    </div>
</body>
