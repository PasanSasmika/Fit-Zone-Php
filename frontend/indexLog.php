...
// ========= CUSTOMER ADDING PLAN FUNCTION START ===========//
$success = '';
...
// ========== CUSTOMER ADDING PLAN FUNCTION END ===========//


//========= CUSTOMER ADDING CLASS FUNCTION START ===========//
...
//======== CUSTOMER ADDING CLASS FUNCTION END ===========//
...
<html lang="en">
  ...
  <body>
      ...
      <div class="section__container header__container" id="home">
        ...
        <div class="header__content">
          ...
          <div class="header__btn">
            <span class="a">Welcome <?php echo $row["name"]; ?></span>
          </div>
        </div>
      </div>
    </header>
    ...
    <section class="section__container class__container" id="class">
      ...
      <?php foreach($class as $clases): ?>
        <div class="class__card">
            <img src="<?php echo '/FitZone/upload_img/' . htmlspecialchars($clases['class_image']); ?>" alt="Class Image" />
            <div class="class__content">
              <h4><?php echo htmlspecialchars($clases['class_name']); ?></h4>
              <p><?php echo htmlspecialchars($clases['class_date']); ?></p>
              <p><?php echo htmlspecialchars($clases['class_time']); ?></p>
              <p><?php echo htmlspecialchars($clases['trainer']); ?></p>
              <h3><?php echo htmlspecialchars($clases['description']); ?></h3>
            </div>
          </div>
        <?php endforeach; ?>
      ...
      <?php foreach($plan as $plans): ?>
        <div class="price__card">
          <div class="price__content">
            ...
            <hr />
            <h4><?php echo htmlspecialchars(string: $plans['trainer']); ?></h4>
